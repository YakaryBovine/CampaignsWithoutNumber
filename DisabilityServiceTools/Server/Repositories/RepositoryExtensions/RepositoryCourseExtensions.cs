...
namespace DisabilityServiceTools.Server.Repositories.RepositoryExtensions
{
  ...
  {
    public static IQueryable<Course> Search(this IQueryable<Course> products, string searchTearm)
    {
    ...
    public static IQueryable<Course> Sort(this IQueryable<Course> products, string orderByQueryString)
    {
